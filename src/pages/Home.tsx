...
export const Home: React.FC = () => {
  ...
  return <div className="min-h-screen w-full bg-primary flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="text-center z-10 max-w-3xl">
        ...
        <p className="text-lg text-textLight/40 mb-6">Your AI-powered copilot for IT incident resolution</p>
