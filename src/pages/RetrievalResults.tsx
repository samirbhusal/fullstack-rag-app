...
export const RetrievalResults: React.FC = () => {
  ...
  const documents = [
    ...
    //   snippet:
    //     "Multiple users reported VPN connection issues following the MFA system upgrade. Root cause was identified as a certificate mismatch between the VPN server and the MFA provider.",
    //   icon: BookOpenIcon,
    //   viewDoc: "View Document →",
    ...
    //   snippet:
    //     "When users cannot authenticate to VPN services after security updates, verify the time synchronization between the authentication server and client devices.",
    //   icon: FileIcon,
    //   viewDoc: "View Document →",
